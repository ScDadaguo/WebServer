### 小记
最近复习了Java IO模型这块知识，也看了一点书，但是就是觉得自己如果不玩一下实战，理解永远不够深入，记忆点太浅，所以我就想着乘着现在还有时间，就去多实战实战。先做了一个基于NIO模型简易版[](https://github.com/ScDadaguo/nio_chat_room)的多人聊天室和一个简易版BIO tomcat初步了解了如何IO编程，了解了一些基础步骤。
...
附上我的笔记[笔记](http://www.dadaguo.mobi/admin/article/71)
